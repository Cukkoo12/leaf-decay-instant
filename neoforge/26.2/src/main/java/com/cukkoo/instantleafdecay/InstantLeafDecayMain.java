...
public class InstantLeafDecayMain {
    ...
    public InstantLeafDecayMain(net.neoforged.bus.api.IEventBus modEventBus, net.neoforged.fml.ModContainer container) {
        InstantLeafDecayConfig.load();
        System.out.println("[HizliYaprak] Mod yuklendi!");
    }

    @EventBusSubscriber(modid = "instant_leaf_decay")
